...
function App() {
    ...
    const [placeList,setPlaceList]=useState(data)
  
    function removePlaceFromList(id) {
      const newPlaces = placeList.filter((place) => place.id !== id);
    ...
    return (
      <div className="App w-screen flex justify-center">
        
        <div className='w-[1000px] flex flex-col items-center'>
          
          <h1 className="text-4xl p-2  w-[500px] font-bold mb-5 border-2 border-black border-dotted rounded-md">
            Plan With Love
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <>
              <p>No Tour available</p>
              <button onClick={setPlaces}>Refresh</button>
            </>
          )}
